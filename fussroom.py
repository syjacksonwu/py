...
class ODISInf(object):
	...
	def __getInstDir(self):		 
		'''		
				获取ODIS安装目录
		'''
		return 'E:\Program Files\Offboard_Diagnostic_Information_System_Engineering'  
...
if __name__ == "__main__":
    ...
    f=file('log_fussroom.txt','w') # open for writing
    ...
    odis.initProject({'sVehicleProject':'VW37XCS', 'sEcuId':'09'})
    odis.initECU({'sVehicleProject':'VW37XCS', 'sEcuId':'09'})
	...
	# readAdaptation
	#dIdentDataResult=odis.readAdaptation('0D0B')
    #print dIdentDataResult
